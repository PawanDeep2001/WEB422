...
export default function AdvancedSearch(data) {
    ...
    function submitForm(data){
        queryString=`/artwork?${data.searchBy}=true${data.geoLocation!=""?"&geoLocation="+data.geoLocation:""}${data.medium!=""?"&medium="+data.medium:""}&isOnView=${data.isOnView}&isHighlight=${data.isHighlight}&q=${data.q}`
